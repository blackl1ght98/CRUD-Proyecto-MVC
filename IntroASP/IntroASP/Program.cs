...
builder.Services.AddAuthentication(options =>
{
    ...
    .AddCookie(options =>
    {
        ...
        options.Cookie.SameSite = SameSiteMode.Strict;//Esta opción previene el envío de la cookie en solicitudes de sitios cruzados. Esto ayuda a prevenir ataques de falsificación de solicitudes entre sitios (CSRF).
